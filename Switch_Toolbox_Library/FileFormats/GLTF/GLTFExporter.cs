    ...
    public class GLTFExporter
    {
            ...
            int ColorsCount, int UVCount, int SkinsCount)
        {
            if (ColorsCount == 0 && UVCount == 0 && SkinsCount == 0)
                AddMeshNormal(meshName, materialIndex, Vertices, Normals, Tangents, TriangleFaces);
            else if (ColorsCount == 0 && UVCount <= 1 && SkinsCount == 0)
                AddMeshNormalUV1(meshName, materialIndex, Vertices,
                    Normals, UV0, Tangents, TriangleFaces);
            else if (ColorsCount == 0 && UVCount <= 2 && SkinsCount == 0)
                AddMeshNormalUV2(meshName, materialIndex, Vertices,
                    Normals, UV0, UV1, Tangents, TriangleFaces);
            else if (ColorsCount <= 1 && UVCount <= 1 && SkinsCount == 0)
                AddMeshNormalColor1UV1(meshName, materialIndex, Vertices,
                    Normals, Colors0, UV0, Tangents, TriangleFaces);
            else if (ColorsCount == 0 && UVCount <= 1 && SkinsCount == 4)
                AddMeshNormalUV1Skin4(meshName, materialIndex, Vertices,
                    Normals, UV0, Skins, Tangents, TriangleFaces);
            else if (ColorsCount <= 1 && UVCount <= 1 && SkinsCount <= 4)
                AddMeshNormalColor1UV1Skin4(meshName, materialIndex, Vertices,
                    Normals, Colors0, UV0, Skins, Tangents, TriangleFaces);
            else if (SkinsCount == 0)  // Maximal rigid mesh
                AddMeshNormalColor2UV4(meshName, materialIndex, Vertices,
                    Normals, Colors0, Colors1, UV0, UV1, UV2, UV3, Tangents,
                    TriangleFaces);
            else
                AddMeshNormalColor2UV4Skin8(meshName, materialIndex, Vertices,
                    Normals, Colors0, Colors1, UV0, UV1, UV2, UV3, Skins, Tangents,
                    TriangleFaces);
        }
            ...
            List<int> TriangleFaces)
        {
            ...
            if (Tangents?.Count > 0)
            {
                var mesh = new MeshBuilder<VertexPositionNormalTangent, VertexEmpty, VertexEmpty>(meshName);
                var prim = mesh.UsePrimitive(GetMaterial(materialIndex));
                for (int i = 0; i < TriangleFaces.Count; i += 3)
                {
                    var v0 = new VertexBuilder<VertexPositionNormalTangent, VertexEmpty, VertexEmpty>();
                    var v1 = new VertexBuilder<VertexPositionNormalTangent, VertexEmpty, VertexEmpty>();
                    var v2 = new VertexBuilder<VertexPositionNormalTangent, VertexEmpty, VertexEmpty>();
                    v0.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i]], Normals[TriangleFaces[i]], Tangents[TriangleFaces[i]]);
                    v1.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i + 1]], Normals[TriangleFaces[i + 1]], Tangents[TriangleFaces[i + 1]]);
                    v2.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i + 2]], Normals[TriangleFaces[i + 2]], Tangents[TriangleFaces[i + 2]]);
            ...
            List<int> TriangleFaces)
        {
            ...
            if (Tangents?.Count > 0)
            {
                ...
                for (int i = 0; i < TriangleFaces.Count; i += 3)
                {
                    var v0 = new VertexBuilder<VertexPositionNormalTangent, VertexTexture1, VertexEmpty>();
                    var v1 = new VertexBuilder<VertexPositionNormalTangent, VertexTexture1, VertexEmpty>();
                    var v2 = new VertexBuilder<VertexPositionNormalTangent, VertexTexture1, VertexEmpty>();
                    v0.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i]], Normals[TriangleFaces[i]], Tangents[TriangleFaces[i]]);
                    v1.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i + 1]], Normals[TriangleFaces[i + 1]], Tangents[TriangleFaces[i + 1]]);
                    v2.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i + 2]], Normals[TriangleFaces[i + 2]], Tangents[TriangleFaces[i + 2]]);
        ...
        public void AddMeshNormalUV2(string meshName, int materialIndex,
            List<Vector3> Vertices, List<Vector3> Normals,
            ...
            List<int> TriangleFaces)
        {
            ...
            if (Tangents?.Count > 0)
            {
                var mesh = new MeshBuilder<VertexPositionNormalTangent, VertexTexture2, VertexEmpty>(meshName);
                var prim = mesh.UsePrimitive(GetMaterial(materialIndex));
                for (int i = 0; i < TriangleFaces.Count; i += 3)
                {
                    var v0 = new VertexBuilder<VertexPositionNormalTangent, VertexTexture2, VertexEmpty>();
                    var v1 = new VertexBuilder<VertexPositionNormalTangent, VertexTexture2, VertexEmpty>();
                    var v2 = new VertexBuilder<VertexPositionNormalTangent, VertexTexture2, VertexEmpty>();
                    v0.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i]], Normals[TriangleFaces[i]], Tangents[TriangleFaces[i]]);
                    v1.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i + 1]], Normals[TriangleFaces[i + 1]], Tangents[TriangleFaces[i + 1]]);
                    v2.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i + 2]], Normals[TriangleFaces[i + 2]], Tangents[TriangleFaces[i + 2]]);
                    v0.Material = new VertexTexture2(UV0[TriangleFaces[i]], UV1[TriangleFaces[i]]);
                    v1.Material = new VertexTexture2(UV0[TriangleFaces[i + 1]], UV1[TriangleFaces[i + 1]]);
                    v2.Material = new VertexTexture2(UV0[TriangleFaces[i + 2]], UV1[TriangleFaces[i + 2]]);
                    prim.AddTriangle(v0, v1, v2);
                }
                Scene.AddRigidMesh(mesh, Matrix4x4.Identity);
            }
            ...
            {
                var mesh = new MeshBuilder<VertexPositionNormal, VertexTexture2, VertexEmpty>(meshName);
                var prim = mesh.UsePrimitive(GetMaterial(materialIndex));
                for (int i = 0; i < TriangleFaces.Count; i += 3)
                {
                    var v0 = new VertexBuilder<VertexPositionNormal, VertexTexture2, VertexEmpty>();
                    var v1 = new VertexBuilder<VertexPositionNormal, VertexTexture2, VertexEmpty>();
                    var v2 = new VertexBuilder<VertexPositionNormal, VertexTexture2, VertexEmpty>();
                    v0.Geometry = new VertexPositionNormal(Vertices[TriangleFaces[i]], Normals[TriangleFaces[i]]);
                    v1.Geometry = new VertexPositionNormal(Vertices[TriangleFaces[i + 1]], Normals[TriangleFaces[i + 1]]);
                    v2.Geometry = new VertexPositionNormal(Vertices[TriangleFaces[i + 2]], Normals[TriangleFaces[i + 2]]);
                    v0.Material = new VertexTexture2(UV0[TriangleFaces[i]], UV1[TriangleFaces[i]]);
            ...
            List<int> TriangleFaces)
        {
            ...
            if (Tangents?.Count > 0)
            {
                ...
                for (int i = 0; i < TriangleFaces.Count; i += 3)
                {
                    var v0 = new VertexBuilder<VertexPositionNormalTangent, VertexColor1Texture1, VertexEmpty>();
                    var v1 = new VertexBuilder<VertexPositionNormalTangent, VertexColor1Texture1, VertexEmpty>();
                    var v2 = new VertexBuilder<VertexPositionNormalTangent, VertexColor1Texture1, VertexEmpty>();
                    v0.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i]], Normals[TriangleFaces[i]], Tangents[TriangleFaces[i]]);
                    v1.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i + 1]], Normals[TriangleFaces[i + 1]], Tangents[TriangleFaces[i + 1]]);
                    v2.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i + 2]], Normals[TriangleFaces[i + 2]], Tangents[TriangleFaces[i + 2]]);
            ...
            List<int> TriangleFaces)
        {
            ...
            if (Tangents?.Count > 0)
            {
                var mesh = new MeshBuilder<VertexPositionNormalTangent, VertexTexture1, VertexJoints4>(meshName);
                var prim = mesh.UsePrimitive(GetMaterial(materialIndex));
                for (int i = 0; i < TriangleFaces.Count; i += 3)
                {
                    var v0 = new VertexBuilder<VertexPositionNormalTangent, VertexTexture1, VertexJoints4>();
                    var v1 = new VertexBuilder<VertexPositionNormalTangent, VertexTexture1, VertexJoints4>();
                    var v2 = new VertexBuilder<VertexPositionNormalTangent, VertexTexture1, VertexJoints4>();
                    v0.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i]], Normals[TriangleFaces[i]], Tangents[TriangleFaces[i]]);
                    v1.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i + 1]], Normals[TriangleFaces[i + 1]], Tangents[TriangleFaces[i + 1]]);
                    v2.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i + 2]], Normals[TriangleFaces[i + 2]], Tangents[TriangleFaces[i + 2]]);
                    v0.Material = new VertexTexture1(UV0[TriangleFaces[i]]);
            ...
            List<int> TriangleFaces)
        {
            ...
            if (Tangents?.Count > 0)
            {
                ...
                for (int i = 0; i < TriangleFaces.Count; i += 3)
                {
                    var v0 = new VertexBuilder<VertexPositionNormalTangent, VertexColor1Texture1, VertexJoints4>();
                    var v1 = new VertexBuilder<VertexPositionNormalTangent, VertexColor1Texture1, VertexJoints4>();
                    var v2 = new VertexBuilder<VertexPositionNormalTangent, VertexColor1Texture1, VertexJoints4>();
                    v0.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i]], Normals[TriangleFaces[i]], Tangents[TriangleFaces[i]]);
                    v1.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i + 1]], Normals[TriangleFaces[i + 1]], Tangents[TriangleFaces[i + 1]]);
                    v2.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i + 2]], Normals[TriangleFaces[i + 2]], Tangents[TriangleFaces[i + 2]]);
                    v0.Material = new VertexColor1Texture1(Colors0[TriangleFaces[i]], UV0[TriangleFaces[i]]);
        ...
        public void AddMeshNormalColor2UV4(string meshName, int materialIndex,
            List<Vector3> Vertices, List<Vector3> Normals,
            List<Vector4> Colors0, List<Vector4> Colors1,
            List<Vector2> UV0, List<Vector2> UV1, List<Vector2> UV2, List<Vector2> UV3,
            List<Vector4> Tangents,
            List<int> TriangleFaces)
        {
            ...
            if (Tangents?.Count > 0)
            {
                var mesh = new MeshBuilder<VertexPositionNormalTangent, VertexColor2Texture4, VertexEmpty>(meshName);
                var prim = mesh.UsePrimitive(GetMaterial(materialIndex));
                for (int i = 0; i < TriangleFaces.Count; i += 3)
                {
                    var v0 = new VertexBuilder<VertexPositionNormalTangent, VertexColor2Texture4, VertexEmpty>();
                    var v1 = new VertexBuilder<VertexPositionNormalTangent, VertexColor2Texture4, VertexEmpty>();
                    var v2 = new VertexBuilder<VertexPositionNormalTangent, VertexColor2Texture4, VertexEmpty>();
                    v0.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i]], Normals[TriangleFaces[i]], Tangents[TriangleFaces[i]]);
                    v1.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i + 1]], Normals[TriangleFaces[i + 1]], Tangents[TriangleFaces[i + 1]]);
                    v2.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i + 2]], Normals[TriangleFaces[i + 2]], Tangents[TriangleFaces[i + 2]]);
            ...
            {
                var mesh = new MeshBuilder<VertexPositionNormal, VertexColor2Texture4, VertexEmpty>(meshName);
                var prim = mesh.UsePrimitive(GetMaterial(materialIndex));
                for (int i = 0; i < TriangleFaces.Count; i += 3)
                {
                    var v0 = new VertexBuilder<VertexPositionNormal, VertexColor2Texture4, VertexEmpty>();
                    var v1 = new VertexBuilder<VertexPositionNormal, VertexColor2Texture4, VertexEmpty>();
                    var v2 = new VertexBuilder<VertexPositionNormal, VertexColor2Texture4, VertexEmpty>();
                    v0.Geometry = new VertexPositionNormal(Vertices[TriangleFaces[i]], Normals[TriangleFaces[i]]);
                    v1.Geometry = new VertexPositionNormal(Vertices[TriangleFaces[i + 1]], Normals[TriangleFaces[i + 1]]);
                    v2.Geometry = new VertexPositionNormal(Vertices[TriangleFaces[i + 2]], Normals[TriangleFaces[i + 2]]);
                    v0.Material = new VertexColor2Texture4(Colors0[TriangleFaces[i]], Colors1[TriangleFaces[i]],
            ...
            List<int> TriangleFaces)
        {
            ...
            if (Tangents?.Count > 0)
            {
                var mesh = new MeshBuilder<VertexPositionNormalTangent, VertexColor2Texture4, VertexJoints8>(meshName);
                var prim = mesh.UsePrimitive(GetMaterial(materialIndex));
                for (int i = 0; i < TriangleFaces.Count; i += 3)
                {
                    var v0 = new VertexBuilder<VertexPositionNormalTangent, VertexColor2Texture4, VertexJoints4>();
                    var v1 = new VertexBuilder<VertexPositionNormalTangent, VertexColor2Texture4, VertexJoints4>();
                    var v2 = new VertexBuilder<VertexPositionNormalTangent, VertexColor2Texture4, VertexJoints4>();
                    v0.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i]], Normals[TriangleFaces[i]], Tangents[TriangleFaces[i]]);
                    v1.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i + 1]], Normals[TriangleFaces[i + 1]], Tangents[TriangleFaces[i + 1]]);
                    v2.Geometry = new VertexPositionNormalTangent(Vertices[TriangleFaces[i + 2]], Normals[TriangleFaces[i + 2]], Tangents[TriangleFaces[i + 2]]);
                    v0.Material = new VertexColor2Texture4(Colors0[TriangleFaces[i]], Colors1[TriangleFaces[i]],
        ...
        public void WriteGLTF(string FileName)
        {
            ...
            model.Asset.Generator = "Switch Toolbox glTF Exporter";
